...
TEXTS: dict[Language, dict[SocialIntent, str]] = {
    ...
    "ru": {
        "greeting": (
            "Привет! Помогу разобраться с этим занятием. Хочешь узнать, почему оно тебе подходит, "
            "чему поможет научиться или какие есть альтернативы?"
        ),
        "thanks": "Пожалуйста! Что ещё хочешь узнать об этом занятии?",
        "language": "Хорошо, отвечу по-русски. Что хочешь узнать об этом занятии?",
        "help": (
            "Я могу объяснить, зачем рекомендовано это занятие, какие навыки оно развивает и какие "
            "есть альтернативы для твоей цели. Что разберём?"
        ),
    },
    "kk": {
        "greeting": (
            "Сәлем! Осы сабақ туралы сұрақтарыңа көмектесемін. Неліктен ұсынылғанын, қандай "
            "дағдыларды дамытатынын немесе басқа нұсқаларды білгің келе ме?"
        ),
        "thanks": "Оқасы жоқ! Осы сабақ туралы тағы не білгің келеді?",
        "language": "Жақсы, қазақша жауап беремін. Осы сабақ туралы не білгің келеді?",
        "help": (
            "Сабақтың неліктен ұсынылғанын, қандай дағдыларды дамытатынын және мақсатыңа сәйкес "
